...
<body>
    ...
    <h1 style="text-align:center">Excluir Tarefa</h1>
    <h4 style="text-align:center">Verifique se realmente deseja excluir esta tarefa!</h4>

    <div class="jumbotron">
        <form method="POST" action="../DATA/apagar_task.php">
        <div class="form-group">
                ...
                <input type="number" class="form-control" style="display:none" readonly='true' name="project_id" id="exampleFormControlInput1" 
                value="<?php echo $project_id; ?>">
                <input type="number" class="form-control" style="display:none" readonly='true' name="idTask" id="exampleFormControlInput1" 
                value="<?php echo $idTask; ?>">
            </div>
            <div class="form-group">
                <label for="exampleFormControlInput1">Título da Tarefa</label>
                <input type="text" class="form-control" name="title"  id="exampleFormControlInput1" value="<?php echo $title; ?>">
            </div>
            <div class="form-group">
                <label for="exampleFormControlInput1">Apelido (Nome para facilitar a associação)</label>
                <input type="text" class="form-control" name="apelido" id="exampleFormControlInput1" value="<?php echo $apelido ?>">
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn btn-danger">Excluir Tarefa</button></div>
        </form>
    </div>
